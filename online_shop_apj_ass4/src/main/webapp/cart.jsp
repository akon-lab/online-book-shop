...
<%
    ...
    Map cart = (HashMap) httpSession.getAttribute("cart");
    Set books = new HashSet();
    if (cart != null) {
        books.addAll(cart.values());
        request.setAttribute("books", books);
    }
%>

<div class="cart mx-auto border">
    <c:if test="${requestScope['books'].sixe()>0}">
        ...
        <c:forEach var="book" items="${cart}">
            <div class="book m-2 border">
                ...
                <div class="text-center">
                    ...
                    <a href="${pageContext.request.contextPath}/book??id=<c:out value="cart.id"/>"
                       style="color: black;">
