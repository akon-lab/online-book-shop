...
<body>
    ...
    <div class="log mx-auto p-2">
        ...
        <div id="auth-cont">
            <form action="${pageContext.request.contextPath}/user" method="post" class="p-3 mx-auto">
                <input type="text" name="username" class="m-1 py-1 px-2 border" placeholder="Username">
                <input type="password" name="password" class="m-1 py-1 px-2 border" placeholder="Password">
